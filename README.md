...
Hardware & Firmware written in **Rust**

LibreRoaster is an open-source project focused on building a customizable and hackable coffee bean roaster. The goal is to provide both hardware designs and firmware that allow full control over the roasting process.
...
For the latest and most stable work-in-progress code, please check the **`develop`** branch.

Expect breaking changes, incomplete features, and experimental designs.
